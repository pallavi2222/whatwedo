...
function Box6() {
    return (
        <div>
            ...
            <ContentOnImage>
            Equality, Growth & Distribution of Prosperity</ContentOnImage>
...
<br/><br/></Content1></Content>
                    <SideContent>
                        ...
                        <Link to="/" style={{textDecoration: 'none'}}><Items>Equality & Distribution of Prosperity</Items></Link>
